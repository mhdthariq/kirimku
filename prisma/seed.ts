...
async function main() {
  ...
  console.log("");
  console.log("Demo DIRECT shipment + transport (Revise round 10):");
  console.log("  MKT-000009 (Rina Amelia, DIRECT, IN_TRANSPORT) — shipment created by adit (umum marketing)");
  console.log("    pickup langsung di lokasi pengirim, kirim langsung ke penerima, tanpa lewat gudang");
  console.log("  TRP-2026-000004 (PLANNED, Medan→Banda Aceh) — transport carrying MKT-000009");
  console.log("    driver: joko, vehicle: BK 8800 KTH (company-owned, no profit share)");
  console.log("");
  console.log("Demo Marketing alignment (Revise round 10):");
  console.log("  budi  — Marketing aligned to Gudang Medan (customers they create auto-inherit Medan gudang)");
  console.log("  adit  — Marketing 'Umum' (no gudang alignment — customers they create need a manual gudang pick)");
  console.log("");
